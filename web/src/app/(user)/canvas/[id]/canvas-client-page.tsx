            ...
            const generationConfig =
                hasSavedImageMetadata && savedImageMetadata
                    ? {
                          ...
                          imageAsync: savedImageMetadata.imageAsync || effectiveConfig.imageAsync || defaultConfig.imageAsync,
                          count: "1",
                      }
...
function buildGenerationConfig(config: AiConfig, node: CanvasNodeData | undefined, mode: CanvasNodeGenerationMode): AiConfig {
    ...
    return {
        ...
        imageAsync: node?.metadata?.imageAsync || config.imageAsync || defaultConfig.imageAsync,
